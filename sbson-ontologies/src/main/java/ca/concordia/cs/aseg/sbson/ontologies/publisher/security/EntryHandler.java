...
public class EntryHandler extends DefaultHandler {
	...
	boolean isCveID, isAffectedProduct, isPublishedDatetime, isLastModifiedDatetime, isScore, isAccessVector,
			isAccessComplexity, isAuthentication, isConfidentialityImpact, isIntegrityImpact, isAvailabilityImpact,
			isCweID, isReferenceType, isReferenceSource = false, isRefernceURL, isSummary;
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		if (qName.equalsIgnoreCase("entry")) {
			// Pass each collected XML tag <entry .. /entry> into the NVD
			// publisher class
