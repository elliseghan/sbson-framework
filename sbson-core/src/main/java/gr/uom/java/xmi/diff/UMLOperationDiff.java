...
public class UMLOperationDiff {
	...
	public void setRemovedOperation(UMLOperation removedOperation) {
		this.removedOperation = removedOperation;
	}

	public void setAddedOperation(UMLOperation addedOperation) {
		this.addedOperation = addedOperation;
	}

	public void setAddedParameters(List<UMLParameter> addedParameters) {
		this.addedParameters = addedParameters;
	}

	public void setRemovedParameters(List<UMLParameter> removedParameters) {
	...
	public void setParameterDiffList(List<UMLParameterDiff> parameterDiffList) {
		this.parameterDiffList = parameterDiffList;
	}
	...
	public void setReturnTypeChanged(boolean returnTypeChanged) {
		this.returnTypeChanged = returnTypeChanged;
	}
	...
	public void setOperationRenamed(boolean operationRenamed) {
		this.operationRenamed = operationRenamed;
	}
}
