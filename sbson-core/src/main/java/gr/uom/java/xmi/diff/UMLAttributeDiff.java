...
public class UMLAttributeDiff {
	...
	public void setRemovedAttribute(UMLAttribute removedAttribute) {
		this.removedAttribute = removedAttribute;
	}

	public void setAddedAttribute(UMLAttribute addedAttribute) {
		this.addedAttribute = addedAttribute;
	}
	...
	public boolean isAttributeRenamed() {
		return attributeRenamed;
	}

	public void setAttributeRenamed(boolean attributeRenamed) {
		this.attributeRenamed = attributeRenamed;
	}
	...
	public void setFinalChanged(boolean finalChanged) {
