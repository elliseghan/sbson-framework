 ...
 */
package ca.concordia.cs.aseg.sbson.ontologies.urigenerator.general.abox;
...
public class MainABox {
	...
	public static String Product(String Product) {
		String uri = NamespaceFactory.createAboxNamespace(NamespaceRegistry.theSEONAboxNameSpace, OntologyRegistry.seon_main)
	...
	public static String File(String project, String file) {
		String uri = NamespaceFactory.createAboxNamespace(NamespaceRegistry.theSEONAboxNameSpace, OntologyRegistry.seon_main)
				+ URLCleaner.clean(project+":"+file);
		return uri;
	}
